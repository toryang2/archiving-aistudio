...
const DEFAULT_CERTIFICATIONS: CertificationRequest[] = [
  {
    ...
    preparedByTitle: 'Assessment Records Officer I',
    verifiedBy: 'Mark Lester G. Reyes, REA',
    verifiedByTitle: 'Local Assessment Operations Officer II / Appraiser',
    approvedBy: 'Atty. Eduardo M. Santos, REA, REB',
    approvedByTitle: 'Municipal Assessor',
  ...
  },
  {
    ...
    preparedByTitle: 'Assessment Operations Officer',
    verifiedBy: 'Glaiza P. Del Rosario, Geodetic Eng.',
    verifiedByTitle: 'Head, Tax Mapping Division',
    approvedBy: 'Atty. Eduardo M. Santos, REA, REB',
    approvedByTitle: 'Municipal Assessor',
    approvalLabel: 'Certified correct as to available record/s:',
